...
init_shim();
import { ProxyNetworkProvider as ProxyNetworkProvider2 } from "@elrondnetwork/erdjs-network-providers";
...
function initializeProxyProvider(networkConfig) {
  const initializationNetworkConfig = networkConfig || networkSelector(store.getState());
  proxyProvider = new ProxyNetworkProvider2(initializationNetworkConfig.apiAddress, {
    timeout: Number(initializationNetworkConfig.apiTimeout)
  });
