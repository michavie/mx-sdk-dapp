...
// src/apiCalls/configuration/getServerConfigurationForEnvironment.ts
function getServerConfigurationForEnvironment(environment) {
  return __async(this, null, function* () {
    const fallbackConfig = fallbackNetworkConfigurations[environment];
    const config = yield getServerConfiguration(fallbackConfig.apiAddress);
...
function getScamAddressData(addressToVerify) {
  return __async(this, null, function* () {
    ...
    const { data } = yield axios4.get(`/accounts/${addressToVerify}`, {
      baseURL: apiAddress,
...
export {
  ...
  getServerConfigurationForEnvironment,
