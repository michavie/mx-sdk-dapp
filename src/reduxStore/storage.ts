...
export const getPersistorLocalStorage = () => {
  console.log('getPersistorLocalStorage', persistorLocalStorage);

  return persistorLocalStorage;
};
// isMobileDevice ? AsyncStorage : persistorLocalStorage;

export const getPersistorSessionStorage = () => {
  console.log('getPersistorSessionStorage', persistorSessionStorage);

  return persistorSessionStorage;
};
